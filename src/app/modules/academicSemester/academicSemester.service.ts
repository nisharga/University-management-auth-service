...
const getAllSemesters = async (
    ...
    const result = await AcademicSemester.find(whereConditions).sort().skip(skip).limit(limit);
...
//     const { page, limit, skip, sortBy, sortOrder } = paginationHelpers.calculatePagination(
//       paginationOptions
//     );
...
const updateSemester = async (id: string, payload: Partial<IAcademicSemester>): Promise<IAcademicSemester> => {
...
const deleteSemester = async (id: string): Promise<IAcademicSemester> => {
